...
export const constantRouterMap = [
  ...
  //     },
  //     {
  //       path: 'factoryGoods/:id(\\d+)',
  //       component: () => import('@/views/factory/goods'),
  //       name: 'factoryGoods',
  //       meta: {
  ...
  //     },
  //     {
  //       path: 'factorySales/:id(\\d+)',
  //       component: () => import('@/views/factory/sales'),
  //       name: 'factorySales',
  //       meta: {
  //         // perms: ['GET /admin/goods/detail', 'POST /admin/goods/update', 'POST /admin/goods/catAndBrand'],
  //         title: '厂家业绩',
  ...
  //     {
  //       path: 'poor',
  //       component: () => import('@/views/poor/index'),
  //       name: 'poor',
  //       meta: {
  //         // perms: ['GET /admin/user/list'],
  //         title: '贫困人员申请',
  ...
  //     {
  //       path: 'baseSetting',
  //       component: () => import('@/views/baseSetting/index'),
  //       name: 'baseSetting',
  //       meta: {
  //         // perms: ['GET /admin/user/list'],
  //         title: '基础设置',
